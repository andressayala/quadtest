...
@configclass
class CustomQuadRoughDepthEnvCfg(LocomotionVelocityRoughEnvCfg):
    def __post_init__(self):
        ...
        # No height scan. We will use depth.
...
@configclass
class CustomQuadRoughDepthEnvCfg_PLAY(CustomQuadRoughDepthEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
